...
class swmmINP:
    ...
    def make_conduit_dictionary(self):
        ...
        for l in self._sections['[XSECTIONS]']:
            ...
            try:
                self.conduits[a[0]]['shape'] = a[1]
                self.conduits[a[0]]['geom1'] = float(a[2])
                self.conduits[a[0]]['geom2'] = float(a[3])
                self.conduits[a[0]]['geom3'] = float(a[4])
                self.conduits[a[0]]['geom4'] = float(a[5])
                self.conduits[a[0]]['barrels'] = int(a[6])
                self.conduits[a[0]]['culvert'] = float(a[7])
            except:
                pass
