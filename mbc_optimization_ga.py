...
fin_list = [
    'NoWestside_withISDs_RainEvents_Simplifying_other2.inp',
    'input_files/ControlPoints-Copy.csv',
    'input_files/Upstream_Init_FV.csv',
    'input_files/Downstream_Init_FV.csv',
    'GA_2017_w_VR02.p'
]
